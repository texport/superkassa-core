package io.github.texport.superkassa.core.data.adapter.generator
...
class UuidGeneratorAdapterTest {
    ...
    fun testGenerateFactoryNumber() {
        val fn = UuidGeneratorAdapter.generateFactoryNumber("KZT")
        assertNotNull(fn)
    ...
    @Test
    fun testGenerateFactoryNumberWithCustomPrefix() {
        val fn = UuidGeneratorAdapter.generateFactoryNumber("USD")
        assertNotNull(fn)
        assertEquals(15, fn.length)
        assertTrue(fn.startsWith("USD"))
    }
}
