...
class ReceiptRenderAdapterTest {
    ...
    fun testRenderHtml() {
        val receipt = ReceiptRequest(
            kkmId = "kkm-1",
            pin = "0000",
            operation = io.github.texport.superkassa.core.domain.model.receipt.ReceiptOperationType.SELL,
            items = emptyList(),
            payments = emptyList(),
            total = io.github.texport.superkassa.core.domain.model.common.Money(0, 0),
            taken = io.github.texport.superkassa.core.domain.model.common.Money(0, 0),
            change = io.github.texport.superkassa.core.domain.model.common.Money(0, 0),
            idempotencyKey = "key-1",
            taxRegime = io.github.texport.superkassa.core.domain.model.common.TaxRegime.VAT_PAYER,
            defaultVatGroup = io.github.texport.superkassa.core.domain.model.common.VatGroup.VAT_16
        )
