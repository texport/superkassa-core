...
class OfdManagerAdapterTest {
    ...
    fun testSendBuilderReturnsNull() {
        ...
        val result = adapter.send(request)
        assertEquals(OfdCommandStatus.FAILED, result.status)
        assertEquals(CoreStrings.ofdRequestFailedData("Missing required request parameters"), result.errorMessage)
    }
    ...
    fun testSendFailureNullMessage() {
        ...
        val result = adapter.send(request)
        assertEquals(OfdCommandStatus.FAILED, result.status)
        assertEquals(CoreStrings.ofdRequestFailedData("unknown"), result.errorMessage)
    }
    ...
    fun testSendUnexpectedExceptionNullMessage() {
        ...
        val result = adapter.send(request)
        assertEquals(OfdCommandStatus.FAILED, result.status)
        assertEquals(CoreStrings.ofdRequestFailedData(null), result.errorMessage)
    }
