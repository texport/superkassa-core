...
class OfdCommandRequestFactory(
    ...
    fun build(
        ...
        val ofdTag = ofdProviderOverride
            ?: kkm.ofdProvider
            ?: throw ValidationException(CoreStrings.ofdProviderRequired(), "OFD_PROVIDER_REQUIRED")
        ...
        val deviceId = systemId.toLongOrNull()
            ?: throw ValidationException(CoreStrings.kkmSystemIdInvalid(systemId), "KKM_SYSTEM_ID_INVALID")
        ...
        val registrationNumber = registrationNumberOverride ?: kkm.registrationNumber
            ?: throw ValidationException(CoreStrings.kkmRegistrationRequired(), "KKM_REG_REQUIRED")
