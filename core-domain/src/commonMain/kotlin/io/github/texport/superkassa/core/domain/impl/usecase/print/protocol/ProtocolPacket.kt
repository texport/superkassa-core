 ...
 * сервер приёма данных хранит документ именно так, и кабинет присылает
 * его на печать в этом же виде. Из пакета собирается то же, что касса
 * подавала рисовальщику, когда печатала документ у себя, — потому и вид
 * документа получается один.
 *
