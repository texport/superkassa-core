...
/**
 * Справочник единиц измерения для фискальных документов, классификатор ИС ЭСФ.
 * Используется для поля measure_unit_code в позициях чека (протокол ОФД с версии 201).
 *
 * @property code Числовой код единицы измерения по классификатору ИС ЭСФ.
...
enum class UnitOfMeasurement(
    ...
    companion object {
        /**
         * Получает единицу измерения по её коду ИС ЭСФ.
         *
         * @param code Строковый код ИС ЭСФ.
