    ...
    fun validateAndFormatTag(providerId: String, environmentId: String): String {
        val provider = OfdProvider.findProvider(providerId)
            ?: throw ValidationException(
                CoreStrings.ofdProviderUnknown(providerId),
