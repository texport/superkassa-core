...
import io.github.texport.superkassa.core.domain.validation.OfdTagValidator
...
interface OfdConfigPort {
     ...
     * @throws io.github.texport.superkassa.core.domain.exception.ValidationException если комбинация невалидна.
     */
     ...
     * @throws io.github.texport.superkassa.core.domain.exception.ValidationException если формат тега некорректен.
     */
