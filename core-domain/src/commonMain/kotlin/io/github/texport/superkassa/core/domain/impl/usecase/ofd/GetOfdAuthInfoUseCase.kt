...
import io.github.texport.superkassa.core.domain.api.model.ofd.OfdAuthInfo
...
class GetOfdAuthInfoUseCase(
     ...
     * @throws io.github.texport.superkassa.core.domain.api.exception.ForbiddenException если у пользователя недостаточно прав.
     */
