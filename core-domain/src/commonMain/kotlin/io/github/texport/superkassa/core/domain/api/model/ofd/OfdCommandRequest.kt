 ...
 * @property knownTicketAds Рекламные строки, уже имеющиеся у кассы: их вид и версию
 * она сообщает ОФД, чтобы получить только новые.
...
data class OfdCommandRequest(
    ...
    val knownTicketAds: List<TicketAd> = emptyList()
)
