...
import io.github.texport.superkassa.core.domain.model.ofd.OfdAuthInfo
...
class GetOfdAuthInfoUseCase(
     ...
     * @throws io.github.texport.superkassa.core.domain.exception.ForbiddenException если у пользователя недостаточно прав.
     */
