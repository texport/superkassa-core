...
class RetryFailedQueueItemsUseCase(
     ...
     *
     * Требует авторизации с ролью [io.github.texport.superkassa.core.domain.model.auth.UserRole.ADMIN].
     *
     ...
     * @throws io.github.texport.superkassa.core.domain.exception.NotFoundException Если ККМ не найдена.
     */
    fun execute(kkmId: String, pin: String): Int {
        ...
        authorizeUserUseCase.requireRole(
            kkmId,
            pin,
            setOf(io.github.texport.superkassa.core.domain.model.auth.UserRole.ADMIN)
        )
