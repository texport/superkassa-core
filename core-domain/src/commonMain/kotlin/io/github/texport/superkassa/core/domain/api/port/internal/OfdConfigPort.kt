...
import io.github.texport.superkassa.core.domain.api.validation.OfdTagValidator
...
interface OfdConfigPort {
     ...
     * @throws io.github.texport.superkassa.core.domain.api.exception.ValidationException если комбинация невалидна.
     */
     ...
     * @throws io.github.texport.superkassa.core.domain.api.exception.ValidationException если формат тега некорректен.
     */
