...
interface TokenCodecPort {
     ...
     * @throws io.github.texport.superkassa.core.domain.exception.ValidationException если переданная строка не является валидным числом.
     */
    fun parseToken(token: String): Long {
        return token.toLongOrNull()
            ?: throw io.github.texport.superkassa.core.domain.exception.ValidationException(
