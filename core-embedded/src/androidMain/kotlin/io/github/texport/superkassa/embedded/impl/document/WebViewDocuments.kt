 ...
 *
 * Форма рисуется шрифтами сборки в растр нужной ширины и высотой по
 * содержимому, и уже растр кладётся на лист PDF, сжимается в PNG или
 * кодируется для термопринтера. Вызывать не из главного потока: WebView
 * работает в нём, и вызов из него же ждал бы сам себя.
 */
